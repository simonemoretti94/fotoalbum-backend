        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                    <div id="laravel-logo" class="logo_laravel d-flex flex-column px-4  {{Auth::check() ? 'b-right' : ''}}">
                        @if (Auth::check())      
                        <img src="{{ Vite::asset('resources/img/album-photo-layout.svg') }}" alt="photos-icon" class="m-auto" style="width: 80px; height: 60px;">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item {{Route::currentRouteName() == 'admin.dashboard' ? 'd-none' : ''}}" href="{{ route('admin.dashboard') }}">{{__('Dashboard')}}</a>
                                <a class="dropdown-item {{Route::currentRouteName() == 'profile.edit' ? 'd-none' : ''}}" href="{{ url('profile') }}">{{__('Profile')}}</a>
