...
<div id="actions">
    ...
    <p><i id="sidebar-icon" class="fa-solid fa-square-plus"></i><a href="{{route('admin.photos.create')}}">Create</a>
    </p>
            ...
            <tbody>
                ...
                <tr class="row-data">
                    ...
                    <td id="td-image">
                        ...
                        @else
                        <img width="150" height="200" src="{{asset('storage/' . $photo->cover_image)}}"
                            alt="{{$photo->title}}">
                        @endif
